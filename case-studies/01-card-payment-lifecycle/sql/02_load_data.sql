...
LOAD DATA INTO `your-project-id.kipo_payments.issuer`
...
LOAD DATA INTO `your-project-id.kipo_payments.bin_range`
...
LOAD DATA INTO `your-project-id.kipo_payments.card`
...
LOAD DATA INTO `your-project-id.kipo_payments.merchant`
...
LOAD DATA INTO `your-project-id.kipo_payments.acquirer`
...
LOAD DATA INTO `your-project-id.kipo_payments.decline_code_catalog`
...
LOAD DATA INTO `your-project-id.kipo_payments.payment_intent`
...
LOAD DATA INTO `your-project-id.kipo_payments.risk_evaluation`
...
LOAD DATA INTO `your-project-id.kipo_payments.auth_attempt`
...
LOAD DATA INTO `your-project-id.kipo_payments.authorization`
...
LOAD DATA INTO `your-project-id.kipo_payments.capture`
...
LOAD DATA INTO `your-project-id.kipo_payments.void_reversal`
...
LOAD DATA INTO `your-project-id.kipo_payments.settlement_batch`
...
LOAD DATA INTO `your-project-id.kipo_payments.refund`
...
LOAD DATA INTO `your-project-id.kipo_payments.dispute`
